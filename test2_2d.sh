...
# Включены все поглощающие граничные условия (dabc=y в madagascar и 4 единицы в конфиге у меня).
...
sfawefd2d < Fwav.rsf vel=Fvel.rsf sou=Fsou.rsf rec=Frec.rsf wfl=Fwfl.rsf \
	den=Fden.rsf > Fdat.rsf verb=y free=n fdorder=2 expl=y snap=y dabc=y jdata=1 jsnap=10
